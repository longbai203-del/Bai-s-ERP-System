...
const placeholderController = {
  list: async (_req: Request, res: Response) => {
    res.json({ success: true, data: [], message: 'Customer list placeholder' });
  },
  getById: async (_req: Request, res: Response) => {
    res.json({ success: true, data: null, message: 'Customer detail placeholder' });
  },
  create: async (_req: Request, res: Response) => {
    res.status(201).json({ success: true, data: null, message: 'Customer created' });
  },
  update: async (_req: Request, res: Response) => {
    res.json({ success: true, data: null, message: 'Customer updated' });
  },
  ...
  search: async (_req: Request, res: Response) => {
    res.json({ success: true, data: [], message: 'Customer search placeholder' });
  },
  export: async (_req: Request, res: Response) => {
    res.json({ success: true, message: 'Customer export placeholder' });
  },
  import: async (_req: Request, res: Response) => {
    res.json({ success: true, message: 'Customer import placeholder' });
  },
  getStats: async (_req: Request, res: Response) => {
    res.json({ success: true, data: {}, message: 'Customer stats placeholder' });
  },
};
