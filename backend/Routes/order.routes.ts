...
const placeholderController = {
  list: async (_req: Request, res: Response) => {
    res.json({ success: true, data: [], message: 'Order list placeholder' });
  },
  getById: async (_req: Request, res: Response) => {
    res.json({ success: true, data: null, message: 'Order detail placeholder' });
  },
  create: async (_req: Request, res: Response) => {
    res.status(201).json({ success: true, data: null, message: 'Order created' });
  },
  update: async (_req: Request, res: Response) => {
    res.json({ success: true, data: null, message: 'Order updated' });
  },
  ...
  search: async (_req: Request, res: Response) => {
    res.json({ success: true, data: [], message: 'Order search placeholder' });
  },
  export: async (_req: Request, res: Response) => {
    res.json({ success: true, message: 'Order export placeholder' });
  },
  import: async (_req: Request, res: Response) => {
    res.json({ success: true, message: 'Order import placeholder' });
  },
  getStats: async (_req: Request, res: Response) => {
    res.json({ success: true, data: {}, message: 'Order stats placeholder' });
  },
};
