...
const placeholderController = {
  list: async (_req: Request, res: Response) => {
    res.json({ success: true, data: [], message: 'Finance list placeholder' });
  },
  getById: async (_req: Request, res: Response) => {
    res.json({ success: true, data: null, message: 'Finance detail placeholder' });
  },
  create: async (_req: Request, res: Response) => {
    res.status(201).json({ success: true, data: null, message: 'Finance created' });
  },
  update: async (_req: Request, res: Response) => {
    res.json({ success: true, data: null, message: 'Finance updated' });
  },
  ...
  search: async (_req: Request, res: Response) => {
    res.json({ success: true, data: [], message: 'Finance search placeholder' });
  },
  export: async (_req: Request, res: Response) => {
    res.json({ success: true, message: 'Finance export placeholder' });
  },
  import: async (_req: Request, res: Response) => {
    res.json({ success: true, message: 'Finance import placeholder' });
  },
};
