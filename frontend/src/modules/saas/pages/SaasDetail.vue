<!--
  文件路径: frontend/src/modules/saas/pages/SaasDetail.vue
  功能: SaaS管理详情
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">SaaS管理详情</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">SaaS管理详情</h1>
      </div>
