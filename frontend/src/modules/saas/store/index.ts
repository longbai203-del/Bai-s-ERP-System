...
export const usesaasStore = defineStore('saas', () => {
  ...
  async function fetchList(params: any = {}) {
    ...
    try {
      // API 调用
      const result = await apiService.get('/saas', {
  ...
  async function fetchById(id: string) {
    ...
    error.value = null;
    try {
      const result = await apiService.get(`/saas/${id}`);
  ...
  async function create(data: any) {
    ...
    error.value = null;
    try {
      const result = await apiService.post('/saas', data);
      await fetchList();
      return result;
    } catch (err: any) {
      error.value = err.message;
  ...
  async function update(id: string, data: any) {
    ...
    error.value = null;
    try {
      const result = await apiService.put(`/saas/${id}`, data);
      await fetchList();
      return result;
    } catch (err: any) {
      error.value = err.message;
  ...
  async function remove(id: string) {
    ...
    error.value = null;
    try {
      await apiService.delete(`/saas/${id}`);
      await fetchList();
    } catch (err: any) {
      error.value = err.message;
      throw err;
