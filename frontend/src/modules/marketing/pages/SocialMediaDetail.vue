<!-- 
  文件路径: frontend/src/modules/marketing/pages/SocialMediaDetail.vue
  功能: 社交媒体 营销详情
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'Dashboard'">社交媒体 营销详情</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">社交媒体 营销详情</h1>
      </div>
