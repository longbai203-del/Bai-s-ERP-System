<!--
  文件路径: frontend/src/modules/analytics/pages/AnalyticsCreate.vue
  功能: 创建数据分析
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">创建数据分析</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">创建数据分析</h1>
      </div>
