<!--
  文件路径: frontend/src/modules/project/pages/Edit.vue
  功能: 编辑项目管理
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">编辑项目管理</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">编辑项目管理</h1>
      </div>
