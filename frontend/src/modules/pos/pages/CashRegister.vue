...
// API 导入
// ============================================================
import { getPOSProducts, createPOSOrder, getCart, addToCart, updateCartItem, removeCartItem, clearCart } from '@/api/modules/pos'
...
const loadProducts = async () => {
  ...
  try {
    const res = await getPOSProducts({ category: categoryFilter.value })
