<!--
  文件路径: frontend/src/modules/orders/pages/FinanceDashboard.vue
  功能: 订单仪表板
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'Dashboard' && pageType !== 'List'">订单仪表板</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">订单仪表板</h1>
      </div>
