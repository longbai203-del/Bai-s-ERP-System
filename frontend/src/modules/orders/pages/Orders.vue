            ...
            <div class="container-fluid">
                <div class="page-header">
                    <div>
                        ...
                        <p class="page-subtitle">管理和追踪所有订单</p>
                    </div>
                    <button class="btn btn-primary" onclick="location.href='#/03-orders/detail'">
                ...
                <div class="search-bar">
                    <div class="search-row">
                        <div class="form-group"><label>订单编号</label><input id="searchOrderNo" type="text" placeholder="输入订单编号" /></div>
                        <div class="form-group"><label>客户名称</label><input id="searchCustomer" type="text" placeholder="输入客户名称" /></div>
                        ...
                        <div class="search-actions">
                            ...
                            <button id="resetBtn" class="btn btn-secondary"><i class="fas fa-undo"></i> 重置</button>
                        </div>
                    </div>
                </div>
                <div class="toolbar">
                    <div class="left">
                        <button class="btn btn-secondary" onclick="location.reload()"><i class="fas fa-sync"></i> 刷新</button>
                    </div>
                </div>
                <div id="summaryContainer" class="mb-4 text-sm text-gray-500"></div>
