<!-- 
  文件路径: frontend/src/modules/customers/pages/Edit.vue
  功能: 编辑客户 - 修改客户信息
-->

<template>
  <div class="customers-edit-page">
    <!-- 页面头部 -->
    <div class="page-header">
      <div class="header-left">
        ...
        <div class="header-title">
          <h1>✏️ 编辑客户</h1>
          <p class="header-subtitle">修改客户信息 - ID: {{ form.id || 'CUS-001' }}</p>
        </div>
      </div>
        ...
        <div class="preview-header">
          ...
          <div class="preview-info">
            ...
            <div class="preview-meta">
              ...
              <span class="preview-id">ID: {{ form.id }}</span>
            </div>
          </div>
        </div>
...
[data-theme="dark"] .customers-edit-page {
  background: #1A1A2E;
}
