<!--
  文件路径: frontend/src/modules/hr/pages/FinanceDashboard.vue
  功能: 人力资源管理仪表板
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">人力资源管理仪表板</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">人力资源管理仪表板</h1>
      </div>
