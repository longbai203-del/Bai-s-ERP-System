<!--
  文件路径: frontend/src/modules/reports/pages/ReportsCreate.vue
  功能: 创建报表管理
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">创建报表管理</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">创建报表管理</h1>
      </div>
