<!--
  文件路径: frontend/src/modules/system/pages/SystemDetail.vue
  功能: 系统管理详情
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">系统管理详情</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">系统管理详情</h1>
      </div>
