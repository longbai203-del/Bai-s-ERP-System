<!--
  文件路径: frontend/src/modules/system/pages/SystemList.vue
  功能: 系统管理列表
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">系统管理列表</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">系统管理列表</h1>
      </div>
