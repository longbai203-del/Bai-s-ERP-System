<!-- 
  文件路径: frontend/src/modules/dashboard/pages/Create.vue
  功能: 创建仪表盘 - 新建仪表盘配置
-->
    ...
    <div class="page-header">
      <div class="header-left">
        ...
        <div class="header-title">
          <h1>📊 创建仪表盘</h1>
          <p class="header-subtitle">配置新的仪表盘，支持自定义布局和图表</p>
        </div>
      </div>
...
import { ArrowLeft, Document, Check, View, Plus, Edit, Delete } from '@element-plus/icons-vue'
...
const form = reactive({
  ...
  theme: 'light',
  description: '',
  charts: [] as Array<{ id: string; name: string; type: string }>
})
...
[data-theme="dark"] .dashboard-create-page {
  background: #1A1A2E;
}
