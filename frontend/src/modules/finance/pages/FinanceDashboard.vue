<!--
  文件路径: frontend/src/modules/finance/pages/FinanceDashboard.vue
  功能: 财务管理仪表板
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">财务管理仪表板</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">财务管理仪表板</h1>
      </div>
