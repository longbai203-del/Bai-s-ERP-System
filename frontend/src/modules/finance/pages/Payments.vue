<!-- 
  文件路径: frontend/src/modules/finance/pages/Payments.vue
  功能: 付款管理 - 管理所有付款记录
-->
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="9">
            <el-form-item>
              ...
              <el-button type="primary" @click="handleCreate" style="float: right"><el-icon><Plus /></el-icon> 新增付款</el-button>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
        ...
        <el-table-column prop="status" label="状态" align="center" width="100">
          <template #default="{ row }">
            <el-tag :type="row.status === 'paid' ? 'success' : row.status === 'pending' ? 'warning' : 'danger'">
              {{ row.status === 'pending' ? '待付款' : row.status === 'paid' ? '已付款' : '已取消' }}
            </el-tag>
          </template>
        </el-table-column>
...
const paymentStats = ref([
  { label: '待付款总额', value: 'SAR 1,856,000', type: 'warning' },
  { label: '本月已付款', value: 'SAR 2,560,000', type: 'success' },
  { label: '逾期付款', value: 'SAR 456,000', type: 'danger' },
])

const tableData = ref([
  { id: 1, paymentNo: 'PAY-2024-001', supplier: 'Apple Supplier', amount: 285600, method: '银行转账', paymentDate: '2024-11-20', status: 'paid' },
  { id: 2, paymentNo: 'PAY-2024-002', supplier: 'Samsung Supplier', amount: 198700, method: '银行转账', paymentDate: '', status: 'pending' },
  { id: 3, paymentNo: 'PAY-2024-003', supplier: 'Dell Supplier', amount: 156800, method: '支票', paymentDate: '2024-11-18', status: 'paid' },
])
...
const handleCreate = () => { ElMessage.info('新增付款') }
