...
const settingsRoutes: RouteRecordRaw[] = [
  ...
  {
    path: '/settings/FinanceDashboard',
  ...
  {
    path: '/settings/InventoryDashboard',
  ...
  {
    path: '/settings/SaudiInvoiceSettings',
  ...
  {
    path: '/settings/SaudiVATSettings',
  ...
  {
    path: '/settings/SettingsDashboard',
    name: 'settingsSettingsDashboard',
  ...
  {
    path: '/settings/WhatsAppSettings',
