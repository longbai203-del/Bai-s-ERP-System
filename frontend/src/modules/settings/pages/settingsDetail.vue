<!--
  文件路径: frontend/src/modules/settings/pages/settingsDetail.vue
  功能: 系统设置详情
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">系统设置详情</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">系统设置详情</h1>
      </div>
