<!--
  文件路径: frontend/src/modules/settings/pages/CompanyProfile.vue
  功能: 系统设置列表
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">系统设置列表</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">系统设置列表</h1>
      </div>
