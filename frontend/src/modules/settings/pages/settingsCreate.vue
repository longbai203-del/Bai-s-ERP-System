<!--
  文件路径: frontend/src/modules/settings/pages/settingsCreate.vue
  功能: 创建系统设置
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'List' && pageType !== 'Dashboard'">创建系统设置</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">创建系统设置</h1>
      </div>
