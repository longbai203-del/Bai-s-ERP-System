<!--
  文件路径: frontend/src/modules/approval/pages/approvalEdit.vue
  功能: 编辑审批
    ...
    <div class="page-header">
      <div class="header-left">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="pageType !== 'Dashboard'">编辑审批</el-breadcrumb-item>
        </el-breadcrumb>
        <h1 class="page-title">编辑审批</h1>
      </div>
